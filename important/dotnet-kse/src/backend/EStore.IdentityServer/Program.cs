...
using EStore.IdentityServer.Data;
using EStore.IdentityServer.IdentityConfigurations;
...
var connectionString = builder.Configuration.GetValue<string>("kse:sqlconn");
